import { calculateCO2Driving } from "./co2";
...
export const formatDrivingText = (co2: number) => {
  const km = calculateCO2Driving(co2);
  ...
  let text = closest.location;
  if (times > 1) {
    text += ` ${+times.toFixed(1)} times`;
  }
